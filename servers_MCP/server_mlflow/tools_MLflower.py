...
# ---------------------------------------------------------------------------------------------------------------------
    ...
    # ---------------------------------------------------------------------------------------------------------------------
    def get_last_run_id(self, experiment_name: str):
        try:
            experiment = mlflow.get_experiment_by_name(experiment_name)
            ...
            print(f"Error getting last run_id: {e}")
            return None
    # ---------------------------------------------------------------------------------------------------------------------
    ...
    def get_uris(self):
        ...
        return artifact_uri
    # ---------------------------------------------------------------------------------------------------------------------
    def save_experiment0(self,experiment_name,params={},metrics={},artifacts=[]):
        mlflow.end_run()
    ...
    # ---------------------------------------------------------------------------------------------------------------------
    def save_experiment(self, experiment_name, params=None, metrics=None, artifacts=None):
        params = params or {}
        metrics = metrics or {}
        ...
        try:
            ...
            print(f"Error in save_experiment: {e}")
            raise